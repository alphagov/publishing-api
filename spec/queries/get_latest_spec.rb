...
RSpec.describe Queries::GetLatest do
  ...
  before do
    FactoryGirl.create(:live_content_item, document: document_a, user_facing_version: 2, base_path: "/a2")
    FactoryGirl.create(:superseded_content_item, document: document_a, user_facing_version: 1, base_path: "/a1")
    FactoryGirl.create(:draft_content_item, document: document_a, user_facing_version: 3, base_path: "/a3")

    FactoryGirl.create(:live_content_item, document: document_b, user_facing_version: 1, base_path: "/b1")
    FactoryGirl.create(:live_content_item, document: document_b_fr, user_facing_version: 2, base_path: "/b2")

    FactoryGirl.create(:live_content_item, document: document_c, user_facing_version: 1, base_path: "/c1")
    FactoryGirl.create(:draft_content_item, document: document_c, user_facing_version: 2, base_path: "/c2")
  end
