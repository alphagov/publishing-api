...
RSpec.describe LiveContentItem do
  ...
  describe ".renderable_content" do
    ...
    let!(:redirect) { FactoryGirl.create(:live_content_item, format: "redirect", base_path: "/bar") }
    let!(:gone) { FactoryGirl.create(:live_content_item, format: "gone", base_path: "/baz") }
