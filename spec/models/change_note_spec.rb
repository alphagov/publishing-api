RSpec.describe ChangeNote do
  ...
  describe "#set_columns_from_edition" do
    it "prevents saving without an edition" do
      change_note = described_class.new
      expect { change_note.save! }.to raise_error(ActiveRecord::RecordInvalid, /Edition must exist/)
    end

    it "populates document_id and user_facing_version from edition before saving" do
      change_note = described_class.new
