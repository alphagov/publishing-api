RSpec.describe V2::ContentItemsController do
  ...
  describe "events" do
    ...
    context "filtering by datetime" do
      ...
      let!(:new_put_content_events) { create_list(:event, 3, content_id: document.content_id, action: "PutContent") }
      let!(:new_publish_events) { create_list(:event, 3, content_id: document.content_id, action: "Publish") }
