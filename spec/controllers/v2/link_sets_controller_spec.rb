  ...
  describe "get_linked" do
    context "called without providing fields parameter" do
      it "is unsuccessful" do
        get :get_linked, content_id: content_id, link_type: "topic"
    ...
    context "called with empty fields parameter" do
      it "is unsuccessful" do
        get :get_linked, content_id: content_id, link_type: "topic", fields: []
    ...
    context "called without providing link_type parameter" do
      before do
        get :get_linked, content_id: content_id, fields: ["content_id"]
      end
    ...
    context "for an existing content item" do
      before do
        get :get_linked, content_id: content_id, link_type: "topic", fields: ["content_id"]
      end
    ...
    context "for a non-existing content item" do
      before do
        get :get_linked, content_id: SecureRandom.uuid, link_type: "topic", fields: ["content_id"]
      end
