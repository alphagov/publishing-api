...
ActiveRecord::Schema.define(version: 20170110075625) do
  ...
  create_table "states", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["edition_id", "name"], name: "index_states_on_edition_id_and_name", using: :btree
    t.index ["edition_id"], name: "index_states_on_edition_id", using: :btree
  end
  ...
  create_table "translations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["edition_id", "locale"], name: "index_translations_on_edition_id_and_locale", using: :btree
    t.index ["edition_id"], name: "index_translations_on_edition_id", using: :btree
  end
  ...
  create_table "user_facing_versions", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["edition_id", "number"], name: "index_user_facing_versions_on_edition_id_and_number", using: :btree
  end
