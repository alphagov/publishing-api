class Edition::Timestamps
  def self.edited(
    ...
    edition.legacy_last_edited_at = payload[:last_edited_at] || now
    ...
    edition.legacy_first_published_at = payload[:first_published_at] ||
      previous_live_version&.legacy_first_published_at
    ...
    edition.legacy_public_updated_at = payload[:public_updated_at]
  ...
  def self.live_transition(
    ...
    unless edition.legacy_first_published_at.present?
      edition.legacy_first_published_at = now
    end
    ...
    if update_type == "major"
      ...
      # sent in put content.
      edition.major_published_at = previous_live_version&.major_published_at
      unless edition.legacy_public_updated_at.present?
        ...
        # isn't available.
        edition.legacy_public_updated_at = previous_live_version&.legacy_public_updated_at || now
      end
    end
