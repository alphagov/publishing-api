  ...
  class DownstreamPresenter
    ...
    def present
      symbolized_attributes
        .except(*%i{last_edited_at id state user_facing_version api_url web_url withdrawn api_path unpublishing_type}) # only intended to be used by publishing applications
