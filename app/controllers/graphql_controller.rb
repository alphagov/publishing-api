  ...
  def draft_content
    execute_in_read_replica do
      begin
        ...
        edition = EditionFinderService.new(encoded_base_path, "draft").find
        ...
        result = PublishingApiSchema.execute(query, variables: { base_path: encoded_base_path, content_store: "draft" }).to_hash
