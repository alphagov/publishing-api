module Sources
  class LinkedToEditionsSource < GraphQL::Dataloader::Source
    ...
    def fetch(editions_and_link_types)
      link_types_map = {}
      sources_and_link_types = editions_and_link_types.map do |edition, link_type|
        link_types_map[[edition.content_id, link_type]] = []
        { edition_id: edition.id, content_id: edition.content_id, link_type: }
      end

      sql_params = {
        sources_and_link_types: sources_and_link_types.to_json,
